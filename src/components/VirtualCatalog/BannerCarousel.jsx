...
const SERVICE_GRADIENTS = {
  ...
  spamBlocker: 'linear-gradient(135deg, #1a1a2e 0%, #2d1b3d 50%, #4a1942 100%)',
  ...
  'Network Discovery': 'linear-gradient(135deg, #1a1a2e 0%, #1b2d3d 50%, #1a3a5c 100%)',
};

// Banner data: one per subscription service
const BANNERS = [
  {
    key: 'WebBlocker',
    headline: 'WebBlocker',
    subheadline: 'URL and content filtering to block access to malicious and inappropriate websites — keeping your network safe from web-based threats.',
    bg: `${import.meta.env.BASE_URL}banners/webblocker-bg.jpg`,
    hero: `${import.meta.env.BASE_URL}banners/webblocker-hero.png`,
  },
  {
    key: 'spamBlocker',
    headline: 'spamBlocker',
    subheadline: 'Real-time spam detection and filtering for inbound email traffic, powered by a continuously updated threat intelligence feed.',
    bg: `${import.meta.env.BASE_URL}banners/spamblocker-bg.jpg`,
    hero: `${import.meta.env.BASE_URL}banners/spamblocker-hero.png`,
  },
  {
    key: 'Gateway AntiVirus',
    headline: 'Gateway AntiVirus',
    subheadline: 'Signature-based antivirus scanning at the gateway to catch known threats before they reach your endpoints.',
    bg: `${import.meta.env.BASE_URL}banners/gav-bg.jpg`,
    hero: `${import.meta.env.BASE_URL}banners/gav-hero.png`,
  },
  {
    ...
    bg: `${import.meta.env.BASE_URL}banners/ips-bg.jpg`,
    hero: `${import.meta.env.BASE_URL}banners/ips-hero.png`,
  },
  {
    ...
    bg: `${import.meta.env.BASE_URL}banners/red-bg.jpg`,
    hero: `${import.meta.env.BASE_URL}banners/red-hero.png`,
  },
  {
    ...
    bg: `${import.meta.env.BASE_URL}banners/appcontrol-bg.jpg`,
    hero: `${import.meta.env.BASE_URL}banners/appcontrol-hero.png`,
  },
  {
    key: 'APT Blocker',
    ...
    bg: `${import.meta.env.BASE_URL}banners/aptblocker-bg.jpg`,
    hero: `${import.meta.env.BASE_URL}banners/aptblocker-hero.png`,
  },
  {
    key: 'Network Discovery',
    headline: 'Network Discovery',
    subheadline: 'Complete visibility into all devices and services on your network topology for better security posture management.',
    bg: `${import.meta.env.BASE_URL}banners/netdisc-bg.jpg`,
    hero: `${import.meta.env.BASE_URL}banners/netdisc-hero.png`,
  },
];

const AUTOPLAY_INTERVAL = 5000;

export default function BannerCarousel({ onScrollTo }) {
